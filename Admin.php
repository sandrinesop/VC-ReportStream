        ...
        <header class="mb-5">
            <nav class=" navbar navbar-expand-lg align-middle navbar-dark fixed-top" style="z-index: 1;">
                    <div class="container px-0">
                        <a class="navbar-brand" href="./Admin.php"><img style=" width: 50px;" class="home-ico" src="./resources/DCA_Admin.png" alt="Digital collective africa logo"> <small>VC ReportStream </small> </a>
