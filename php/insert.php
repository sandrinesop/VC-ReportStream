<?php
    if ( isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO news(NewsID, CreatedDate, ModifiedDate, NewsDate, NewsLink) 
        VALUES (uuid(), now(), now(),'$NewsDate', '$NewsLink')";
        ...
        if($query3){
            $sql4 = "INSERT INTO fund(FundID, CreatedDate, ModifiedDate, FundName, CommittedCapitalOfFund, CommittedCapital, MinimumInvestment, MaximumInvestment)
            VALUES (uuid(), now(), now(), '$FundName', '$CommittedCapitalOfFund', '$CommittedCapital', '$MinimumInvestment', '$MaximumInvestment')";
        ...
        if($query4){
            ...
            VALUES (uuid(), now(), now(), (select Fund.FundID FROM Fund where Fund.FundName = '$FundName'), (select News.NewsID FROM News where News.NewsURL = '$NewsLink'))";
        ...
        if($query3){
            ...
            VALUES (uuid(), now(), now(), (select Investor.InvestorID FROM Investor where Investor.InvestorName = '$InvestorName'), (select News.NewsID FROM News where News.NewsURL = '$NewsLink'))";
        ...
        if($query2){
            ...
            VALUES (uuid(), now(), now(),(select PortfolioCompany.PortfolioCompanyID FROM PortfolioCompany where PortfolioCompany.PortfolioCompanyName = '$PortfolioCompanyName'), (select News.NewsID FROM News where News.NewsURL = '$NewsLink'))";
