            ...
            <div class="card container p-0">
                ...
                <div class="card-body">
                    <form class="container" id="login" action="./process_registration.php" method="POST">
                        ...
                        <div class="mb-3 email-container">
                            <label for="Email" class=" col-form-label">LinkedIn</label>
                            <div class="username">
                                <input required  type="text" class="form-control" id="LinkedIn" placeholder="Enter LinkedIn profile"  name="LinkedIn">
                            </div>
                            <hr >
                        </div>
                        <div class="mb-3">
